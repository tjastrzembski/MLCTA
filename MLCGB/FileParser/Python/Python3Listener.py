...
class Python3Listener(ParseTreeListener):
    ...
    # Enter a parse tree produced by Python3Parser#zope_fct_call.
    def enterZope_fct_call(self, ctx:Python3Parser.Zope_fct_callContext):
        pass

    # Exit a parse tree produced by Python3Parser#zope_fct_call.
    def exitZope_fct_call(self, ctx:Python3Parser.Zope_fct_callContext):
        pass
    ...
    # Enter a parse tree produced by Python3Parser#zope_keyword.
    def enterZope_keyword(self, ctx:Python3Parser.Zope_keywordContext):
        pass

    # Exit a parse tree produced by Python3Parser#zope_keyword.
    def exitZope_keyword(self, ctx:Python3Parser.Zope_keywordContext):
        pass
